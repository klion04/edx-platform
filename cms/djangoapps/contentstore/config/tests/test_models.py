...
from cms.djangoapps.contentstore.config.models import NewAssetsPageFlag
from cms.djangoapps.contentstore.config.tests.utils import new_assets_page_feature_flags
